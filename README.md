...
[API Documentation](https://docs.rs/rate_my_professor_api_rs/0.1.4/rateMyProfessorApi_rs/) : To get better understanding of implementation details.
...
```
### Getting Help
- If the [API Documentation](https://docs.rs/rate_my_professor_api_rs/0.1.4/rateMyProfessorApi_rs/) doesn't help and you happen to be stuck on something, there's also examples within the **bin** folder containing executable code.
